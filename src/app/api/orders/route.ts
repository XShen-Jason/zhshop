...
export async function POST(request: Request) {
    try {
        ...
        if (body.itemType === 'GROUP' && body.itemId) {
            ...
            // Payment Logic Removed for Stable Release
            return NextResponse.json({
                success: true,
                order: data,
        ...
        // Generic Product Order Success (Payment Removed)
        console.log('[DEBUG] Order created. Type:', body.itemType);

        return NextResponse.json({ success: true, order: data, payUrl: null });

                    ...
                    <div className="p-6">
                        ...
                        <div className="bg-gray-50 rounded-xl p-4 mb-6">
                            <div className="flex justify-between text-sm mb-2">
                                ...
                                <span className="font-bold text-gray-900">¥{groupPrice}/份</span>
                            </div>
                            <div className="flex justify-between text-sm mb-2">
                                <span className="text-gray-500">进度</span>
                                <span className="text-gray-900">{currentCount}/{targetCount} 份</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-gray-500">剩余名额</span>
                                <span className="font-bold text-indigo-600">{targetCount - currentCount} 份</span>
                            </div>
                        </div>
